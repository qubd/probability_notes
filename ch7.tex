...
\eqns{E(\xbar) &= E\left(\frac{X_1+X_2+\,\cdots\,+X_n}{n}\right) \\
...
\end{pf}
\par
The results concerning the mean and standard deviation of $\overline{X}$ we obtained before applying Chebyshev's Inequality are significant and useful in their own right, so we'll restate them below.
