...
\eqns{\text{Var}(\xbar) &= \text{Var}\left(\frac{X_1+X_2+\,...\,+X_n}{n}\right) \\ 
&= \frac{1}{n^2}\text{Var}(X_1 + X_2 + \, ... \, + X_n) \\
...
&= \textstyle\frac{1}{n-1}\displaystyle \left(n(Var(X) + (E[X])^2) - n(Var(\xbar)+(E[\xbar])^2)\right)\\
&= \textstyle\frac{1}{n-1}\displaystyle \left(n(\sigma^2 + \mu^2) - n(\frac{\sigma^2}{n}+\mu^2)\right) \\
