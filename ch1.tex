...
\eqnsgap{P(A \given B) = \frac{P(B \given A)P(A)}{P(B)}}
\end{thm}
\par
...
\par
Bayes' rule is shown in a compact form above. However in many applications, it's natural to expand the denominator using the law of total probability, as we'll see in the examples that follow. 
...
\end{cor}
\begin{pf}
Apply Bayes' rule as presented in Theorem \ref{BayesRule}, and expand the denominator using the law of total probability.
\end{pf}
\par
